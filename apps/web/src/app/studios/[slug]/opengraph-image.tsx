...
export const alt = "Miru — studio detail card";
...
export default async function OpenGraphImage({ params }: Props) {
  ...
  const detail = await fetchStudioDetail(slug).catch(() => null);
  const name = detail?.name ?? "Studio";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>{total.toLocaleString("fr-FR")} productions</span>
          {avgRating != null && (
